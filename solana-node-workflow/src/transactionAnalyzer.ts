...
export class TransactionAnalyzer {
   ...
   */
  public async analyzeTransaction(address: string): Promise<TransactionAnalysis> {
    try {
   ...
   */
  public async getTransactionData(address: string): Promise<any> {
    try {
   ...
   */
  public async classifyTransaction(transactionData: any, llmModel: string): Promise<string> {
    try {
   ...
   */
  public async analyzeWithExpert(signature: string): Promise<string> {
    try {
      ...
      //   llmModel,
      // });
      const response = await axios.post(`${this.baseUrl}/api/tx-analyze`, {
   ...
   */
  public async generateMermaid(signature: string): Promise<string> {
    try {
