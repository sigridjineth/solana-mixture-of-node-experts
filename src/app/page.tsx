                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription className="py-4">
                      <p className="mb-4">
                        A visual node-based dashboard for building, analyzing, and visualizing
                        Solana blockchain transactions. This dashboard allows you to create
                        workflows by connecting various nodes to fetch, analyze, and visualize
                        transaction data from the Solana blockchain.
                      </p>
                      <p className="mb-4">
                        With this tool, you can easily analyze transactions, generate
                        visualizations, track account history, and gain insights into on-chain
                        activities without writing code.
                      </p>
